...
import 'package:lesson_49/homework/views/screens/home_screen.dart';
import 'package:lesson_49/homework/views/screens/profile_screen.dart';
  ...
  Widget build(BuildContext context) {
    return IndexedStack(
      ...
      children: [
        ...
        StatisticScreen(onItemTapped: _onItemTapped, currentIndex: _currentIndex),
